...
const GoalCard = props => {
	...
	const deleteHandler = e => {
		...
		axiosWithAuth()
			.delete(
				`https://lifegpa-api.herokuapp.com/habits/${props.goal.habit_id}`
			)
			.then(res => {
	...
	const completeHandler = e => {
		...
		axiosWithAuth()
			.post(
				`https://lifegpa-api.herokuapp.com/users/${id}/habits/completed`,
				{
					habit_id: habit_id,
				}
			)
			...
			<div className="goal-info">
				...
				<div className="goal-details">
					...
					<div className="start-end">
						<div>started</div>
						<h5>
							{moment(props.goal.start_date).format(
								"MMMM Do, YYYY"
							)}
						</h5>
						{props.goal.end_date
